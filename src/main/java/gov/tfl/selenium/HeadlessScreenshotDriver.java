...
public class HeadlessScreenshotDriver extends HtmlUnitDriver implements TakesScreenshot {
    ...
    public HeadlessScreenshotDriver() {
        super();
    }

    public HeadlessScreenshotDriver(boolean enableJavascript) {
        super(enableJavascript);
    }

    public HeadlessScreenshotDriver(Capabilities capabilities) {
        super(capabilities);
    }

    public HeadlessScreenshotDriver(BrowserVersion version) {
        super(version);
